...
EOF
    ...
    crypt_username=$(echo -n 186xxxx6778 | openssl rsautl -encrypt -inkey $workdir/rsa_public.key -pubin -out >(base64 | tr "\n" " " | sed s/[[:space:]]//g))
...
&appId=3f31e4f31439ef1c9288878871f9b2c2c837668ef5e695eb9dddda7a6c56a57ed4d8dda152ea2c097a4451ce6293ba07cadbcdec10396979046b647014efd1e830af1ec9c8ab8d8030f2b0338c8d31db
